...
async fn main() {
    ...
    let options = poise::FrameworkOptions {
        commands: vec![
            ...
            commands::timedgame::worduel_challenge_timed(),
            commands::timedgame::worduel_accept_timed(),
            commands::timedgame::worduel_send_timed(),
            commands::timedgame::worduel_forfeit_timed(),
            commands::timedgame::worduel_keyboard_timed(),
